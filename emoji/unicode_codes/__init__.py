...
__all__ = [
    ...
    'EMOJI_UNICODE_INDONESIAN', 'UNICODE_EMOJI_INDONESIAN',
...
EMOJI_UNICODE_INDONESIAN = get_emoji_unicode_dict('id')
UNICODE_EMOJI_INDONESIAN = get_unicode_emoji_dict('id')
